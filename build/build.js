(() => {
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\.yarn\cache\object-assign-npm-4.1.1-1004ad6dec-fcc6e4ea8c.zip\node_modules\object-assign\index.js
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\.yarn\cache\scheduler-npm-0.20.2-90beaecfba-c4b35cf967.zip\node_modules\scheduler\cjs\scheduler.development.js
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\.yarn\__virtual__\react-reconciler-virtual-bc88299c9c\0\cache\react-reconciler-npm-0.26.2-284c00acc7-2ebceace56.zip\node_modules\react-reconciler\cjs\react-reconciler.development.js
  var require_react_reconciler_development = __commonJS({
    "pnp:C:\\Users\\gobbimar\\IdeaProjects\\pptx-renderer\\.yarn\\__virtual__\\react-reconciler-virtual-bc88299c9c\\0\\cache\\react-reconciler-npm-0.26.2-284c00acc7-2ebceace56.zip\\node_modules\\react-reconciler\\cjs\\react-reconciler.development.js"(exports, module) {
      "use strict";
      if (true) {
        module.exports = function $$$reconciler($$$hostConfig) {
          ...
          function schedulePassiveEffects2(finishedWork) {
            var updateQueue = finishedWork.updateQueue;
            var lastEffect = updateQueue !== null ? updateQueue.lastEffect : null;
            if (lastEffect !== null) {
              var firstEffect = lastEffect.next;
          ...
          function commitLifeCycles(finishedRoot, current2, finishedWork, committedLanes) {
            switch (finishedWork.tag) {
              ...
              case Block: {
                ...
                schedulePassiveEffects2(finishedWork);
                return;
              }
              case ClassComponent: {
                var instance = finishedWork.stateNode;
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\.yarn\__virtual__\react-reconciler-virtual-bc88299c9c\0\cache\react-reconciler-npm-0.26.2-284c00acc7-2ebceace56.zip\node_modules\react-reconciler\index.js
  var require_react_reconciler = __commonJS({
    "pnp:C:\\Users\\gobbimar\\IdeaProjects\\pptx-renderer\\.yarn\\__virtual__\\react-reconciler-virtual-bc88299c9c\\0\\cache\\react-reconciler-npm-0.26.2-284c00acc7-2ebceace56.zip\\node_modules\\react-reconciler\\index.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\renderer\src\host.js
  var import_react_reconciler = __toESM(require_react_reconciler());
  var import_scheduler = __toESM(require_scheduler());

  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\renderer\src\props-equal.js
  var propsEqual = (a, b) => {
  ...
  var props_equal_default = propsEqual;

  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\primitives\src\index.js
  ...
  var emptyObject = {};
  var HostConfig = {
    schedulePassiveEffects: import_scheduler.unstable_scheduleCallback,
    cancelPassiveEffects: import_scheduler.unstable_cancelCallback,
    ...
    createTextInstance(text, rootContainerInstance) {
      return { type: TextInstance, value: text };
    },
    ...
    prepareUpdate(element, type, oldProps, newProps) {
      return !props_equal_default(oldProps, newProps);
    },
  ...
  var renderer = new import_react_reconciler.default(HostConfig);

  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\layout\src\layout.js
  var isTextInstance = ({ type }) => type === TextInstance;
  YOGA_CONFIG.setPointScaleFactor(0);
  var flattenArr = (arr, props) => {
    const result = [];
    arr.forEach((item) => {
  ...
  var layoutText = (node) => {
    ...
    values = values.filter(isTextInstance).map(({ value, props: { x: x2, y: y2, w: w2, h: h2, ...options } }) => ({
      text: value,
      options
    }));
    return {
  ...
  var layoutNotes = (node) => {
    const text = node.children.filter(isTextInstance).map(({ value }) => value).join(" ");
    return {
      ...node,
      text
    };
  };
  var layoutSection = (node) => ({
    ...node,
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\render\src\context.js
  var import_pptxgenjs = __toESM(__require("pptxgenjs"));
  var Pptxgen = class {
    constructor(props) {
      this.pres = new import_pptxgenjs.default();
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\render\src\render.js
  var renderText = (ctx, node) => {
    const { options, children } = node;
    ctx.addText(children, options);
  };
  var renderImage = (ctx, node) => {
    ctx.addImage(node.props);
  };
  var renderShape = (ctx, node) => {
    ctx.addShape(node);
  };
  var renderSlide = (ctx, node) => {
    ctx.addSlide(node.props);
  };
  var renderSlideNumber = (ctx, node) => {
    ctx.addSlideNumber(node.props);
  };
  var renderNotes = (ctx, node) => {
    ctx.addNotes(node.text);
  };
  var renderSection = (ctx, node) => {
    ctx.addSection(node.props);
  };
  var shouldRenderChildren = ({ type }) => type !== Text;
  var Types = {
    [Section]: renderSection,
    [Slide]: renderSlide,
    [SlideNumber]: renderSlideNumber,
    [Text]: renderText,
    [Image]: renderImage,
    [Shape]: renderShape,
    [Notes]: renderNotes
  ...
  // pnp:C:\Users\gobbimar\IdeaProjects\pptx-renderer\packages\renderer\src\ppxt.js
  var PPTX = {
    render(doc, callback) {
